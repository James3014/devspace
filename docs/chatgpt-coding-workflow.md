...
`devspace agents ls`, `devspace agents run`, `devspace agents show`, and
`devspace agents cancel` workflow. The catalog comes from `open_workspace`; `devspace agents ls` lists

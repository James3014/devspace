...
// Nexus-new #526 current accepted recovery manager. PR #979 final head d623d5d0
// bounded the persistent bare-repository fsck timeout without changing recovery authority semantics.

    ...
    toolNames.shell,
    {
      ...
      inputSchema: {
        ...
        command: z
          .string()
          .describe(
            `Shell command to run. Use ${toolNames.edit} or ${toolNames.write} for direct project-file changes; devspace agents ... and devspace workflow ... are the supported orchestration exceptions.`,
          ),
        workingDirectory: z
          .string()
          .optional()
